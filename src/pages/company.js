          ...
          meta={[
            {
              name: 'description',
              content:
                'We make great and efficient productivity apps for iPhone, iPad and Mac. We keep things simple to help you focus on what you do best. Less really is more.',
            },
            {
              property: 'og:title',
            ...
            <div>
              ...
              <div className="hero-wrapper">
                <div className="text-wrapper">
                  ...
                  <h5 className="hidden">
                    We create tools for mac, web and mobile that help you focus
                    on what you do best and generally make your life easier.
                  </h5>
                </div>
                <div className="row">
          ...
          <div className="section cta-contact-us">
            <div className="row">
              <div className="col-12">
                ...
                <h5>
                  If you're having problems with one of our apps, have a project
                  that needs some UX love, or just want to say hello, get in
            ...
            <div className="container">
              <div className="row">
                <div className="col-12">
                  ...
                  <p>
                    No spam, no junk, just great content. Unsubscribe with one
                    click.
                  </p>
                </div>
              </div>
