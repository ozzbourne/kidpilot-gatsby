              ...
              <div>
                ...
                <div className="hero-wrapper">
                  <div className="text-wrapper">
                    ...
                    <h5 className="hidden">
                      We create tools for mac, web and mobile that help you
                      focus on what you do best and generally make your life
                      easier.
                    </h5>
                  </div>
                  <div className="row">
            ...
            <div className="section cta-contact-us">
              <div className="row">
                <div className="col-12">
                  ...
                  <h5>
                    If you're having problems with one of our apps, have a
                    project that needs some UX love, or just want to say hello,
