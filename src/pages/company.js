...
class companyPage extends React.Component {  
  componentDidMount(){
    ...
    $('#mc-form').ajaxChimp({
      url: 'http://wearekidpilot.us13.list-manage.com/subscribe/post?u=ab1cde36fdda5421103c641ed&amp;id=9dbf30c533',
              ...
              <div className="cta">
               ...
               <div className="hero-wrapper">
                 <div className="text-wrapper">
                    ...
                    <h4 className="hidden">We create tools for mac, web and mobile that help you focus on what you do best and generally make your life easier.</h4>
                 </div>
                 <div className="row">
          ...
          <div className="section cta-contact-us">
            <div className="row">
                 <div className="col-12">
                    ...
                    <h4>If you're having problems with one of our apps, have a project that needs some UX love, or just want to say hello, get in touch with us and we'll get back to you as soon as possible.</h4>
