            ...
            <div className="container">
              ...
              {/* <div className="row appRow">
                <div className="app col-12 col-md-6">
                  <div>
                    <Link className="img-link" to="/punchin/ios">
                      <img src={punchInIosIcon} alt="Punch In iOS Icon" />
                    </Link>
                  </div>
                  <h3>Punch In</h3>
                  <h6>
                  ...
                  <h5>
                    Make time tracking less time consuming. Combine projects
                    with clients, archive, lock or delete your projects,
                    add/remove time on the go. Less really is more.
                  </h5>
                ...
                <div className="app col-12 col-md-6">
                  ...
                  <h5>
                    Make time tracking less time consuming. Combine projects
                    with clients, archive or delete projects, add/remove time,
                    set hourly rate and more. Less really is more.
                  </h5>
                  <div className="buttons row">
                    <div className="button">
                      <Link to="/punchin/mac">
              ...
              <div className="row appRow">
                <div className="app col-12 col-md-6">
                  <div>
                    <Link className="img-link" to="/ouff">
                      <img src={ouffIcon} alt="Ouff" />
                    </Link>
                  </div>
                  <h3>Ouff</h3>
                  <h6>
                    <span>Free</span> for phone and tablet
                  </h6>
                  <h5>
                    Ouff delivers daily insults with genuine affection. It´s all
                    about the timing. Every day, weekends, once a week; when is
                    up to you. That´s it.
                  </h5>
                  <div className="buttons row">
                    <div className="button">
                ...
                <div className="app col-12 col-md-6">
                  ...
                  <h5>
                    Snap photos, draw sketches, write notes, record audio.
                    Something automagically saves everything, all in one place.
