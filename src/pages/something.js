          ...
          <div className="something">
                ...
                <div className="row hero-wrapper">
                  <div className="col-12 col-lg-7">
                    <div className="text-wrapper">
                      <h1 className="hidden">
                        Something
                        <br /> to catch everything
                      </h1>
                      <h2 className="hidden">
                        Catch groundbreaking ideas or everyday moments within
                        seconds. Refreshingly simple.
                      </h2>
                      <div className="apple-link hidden">
                        ...
                        <a
                          ...
                          href="http://appstore.com/somethingtocatcheverything"
                        >
                          <img
                ...
                <div className="row">
                  <div className="col-12">
                    <h3 className="header-one">
                      ...
                      Everything is instantly saved in the Something library for
                      easy access.
                    </h3>
                  </div>
                  ...
                  <div className="col-12 col-md-3 icon">
                    ...
                    >
                      ...
                      >
                        ...
                        <path
                          className="st0"
                          d="M1,37.8C1,47.3,8.7,55,18.2,55"
                        />
                      </svg>
                  ...
                  <div className="col-12 col-md-3 icon">
                    ...
                    >
                      ...
                      >
                        <path
                          className="st0"
                          d="M17.2,37.8C17.2,47.3,9.5,55,0,55"
                        />
                      </svg>
                      <line
                        x1="0%"
            ...
            <div className="section customer-reviews">
              <div className="container">
                ...
                <h5>
                  “What a great app. Instantly capture scribble, text note,
                  photo, or audio note. Interface is sleek and simple.”
                </h5>
                <p>– John, Anaheim</p>
                <h5>“Let's me do everything I need when I get an idea.”</h5>
                <p>– johanbolander</p>
                <h5>“Best free app!!”</h5>
                <p>– Tekson</p>
                <h5>“Really sleek app, all in one place!”</h5>
                <p>– Bampete</p>
              </div>
            </div>
              ...
              <div className="container app">
                <div className="row">
                  <div className="col-12 col-lg-6 offset-lg-3">
                    ...
                    <h3>Get Something</h3>
                    <h6>Catch everything within seconds.</h6>
                  </div>
                </div>
                <div className="row">
                  <a
                ...
                <div className="row">
                  <div className="col-12 release-notes release-notes-something">
                    <div className="mt-4">
                      <a href="https://blog.wearekidpilot.com/tagged/release-notes-something">
                        Release notes
                      </a>
                      <p>
                        Requires iOS 10.3 or newer. Compatible with iPhone, iPad
                        and iPod touch.
                      </p>
                    </div>
                  </div>
