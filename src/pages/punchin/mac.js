                ...
                <div className="col-12 col-xl-5">
                  <div className="text-wrapper">
                    ...
                    <div className="apple-link hidden row">
                      <a target="_blank" rel="noopener noreferrer" className="d-none d-md-block col-6" href="https://itunes.apple.com/se/app/punch-in/id519552546?mt=12">
                        <img className="store-link" src={macAppStore} alt="Mac App Store"/>
                      </a>
                      <a target="_blank" rel="noopener noreferrer" className="col-12 col-md-6" href="https://appstore.com/punchintimetracker">
