      ...
      <Layout>
        <Helmet
          ...
          meta={[
            ...
            { property: 'og:url', 
             content: 'https://www.wearekidpilot.com/punchin/ios' },
            { property: 'og:description', 
             content: 'Punch In is a simple and efficient worktimer made to help you keep track of your work. Runs smoothly in the background while you focus on what you do best.' },
            { property: 'og:image', content: `https://wearekidpilot.com${punchInIcon}` }
          ]}
        >
          <html lang="en" />
        ...
        <div className="punchin">
          ...
          <div className="section jumbotron-custom">
            ...
            <div className="whitespace row" id="section"></div>
          </div>
          <div className="section hiw">
              ...
              <div className="row btn-row">
                <div className="col-12">
                  <div className="btn-group btn-group-toggle" data-toggle="buttons">
                    <label onClick={() => showMac()} className="btn btn-primary btn-lg" id="mac">
                      <input type="radio" name="options" id="option1" autoComplete="off" />
                    for Mac
                    </label>
                    <label onClick={() => showiOS()} className="btn btn-primary btn-lg active" id="ios">
            ...
            <div id="mac-section" style={{display: 'none'}}>
              <div className="section hiw">
                <div className="container">
                  <div className="row">
