        ...
        <div className="navigation">
          <ul className="nav flex-row">
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Mac Appzz<img className="menu-arrow" src={arrow} alt="Toggler Arrow"/></a>
