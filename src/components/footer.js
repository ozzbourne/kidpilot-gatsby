...
class Footer extends React.Component {
  /* If-statement below checks if page is "/blog" and in that case renders no Footer, else renders Footer as usual.
  When blog is shown via <iframe> the footer is visible for a split second then gets hidden by <iframe>-content, 
