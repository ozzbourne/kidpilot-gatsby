    ...
    <div id="mac-section" style={{display: props.displayProp}}>
        ...
        <div className="container app">
            ...
            <div className="col-12 col-lg-8 offset-lg-2">
                <a target="_blank" className="img-link" href="https://itunes.apple.com/se/app/punch-in/id519552546?mt=12">
            ...
            <div className="row">
            <a target="_blank" href="https://itunes.apple.com/se/app/punch-in/id519552546?mt=12">
